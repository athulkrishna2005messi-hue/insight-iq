...
export default function Home() {
  return (
    <main
      className="flex min-h-screen flex-col items-center gap-8 px-6"
      style={{
        minHeight: "100vh",
        display: "flex",
    ...
    >
      ...
      <section className="w-full max-w-3xl">
        <div className="rounded-2xl bg-white p-8 shadow">
          <h2 className="text-3xl font-bold text-gray-900">Welcome to Insight iQ</h2>
          <p className="mt-4 text-gray-600">Explore insights and analytics for your members.</p>
          <Link
            href={`/dashboard/${mockCompany.companyId}`}
            className="mt-6 inline-flex items-center justify-center rounded-lg bg-blue-600 px-6 py-2 text-sm font-medium text-white transition hover:bg-blue-700"
          >
            Go to Dashboard
          </Link>
        </div>
